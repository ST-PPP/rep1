...
class User(AbstractUser): # СТ добавили ещё одно поле для имеила, чтобы новый пользователь мог указать больше чем один свой имеил, и получил на оба имеила приветственное письмо
    eamil_2 = models.EmailField(unique=True)